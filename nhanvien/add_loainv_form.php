    ...
    <div id="content-wrapper" class="d-flex flex-column w-100">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <form action="chucnang/add_loainv.php" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label>Tên loại nhân viên</label>
                        <input type="text" id="tenloai" name="tenloai" class="form-control" placeholder="" autofocus required>
                    </div>
                    <button class='w-100 btn' style='background-color:rgb(117, 114, 179);color:white' type='submit'>Thêm loại nhân
                        viên</button>
                </form>
            </div>
            <!-- /.container-fluid -->
